...
<head>
    ...
    <title>Student Dashboard | Lasu Assignment Portal</title>
...
<header>
    ...
    <img src="../img/lasu logo.png" alt="">
    <div id="detail"><?php echo"<br>$username" ?></div>
    ...
    <div id="user_details">
        ...
        <table>
            ...
            <tr>
                <td class="detail_item">Matric No</td>
